...
TimeFrame = pd.DataFrame(columns =['ZoneBaseKey','IDNumber','DateTimeKey','UTCDateTimeValue','Zone','DateTimeValue'])
################################################################
...
PersonFrame = pd.DataFrame(columns = ['IDNumber','FirstName','LastName','Zone','DateTimeValue'])
################################################################
TimeHub=PersonFrame
TimeHubIndex=TimeHub.set_index(['IDNumber'],inplace=False)
######################################################## ########
